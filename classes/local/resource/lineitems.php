...
class lineitems extends \mod_lti\local\ltiservice\resource_base {
     ...
     * @param int    $typeid         To know if we are going to use LTIadvantage or not in this query.
     *
     * return string
     */
    private function get_request_json($contextid, $items, $resourceid, $ltilinkid, $limitfrom, $limitnum, $typeid) {
